...
|---|---|---|
| `ems-industrial-gateway`, `ems-line-controller` | `GET /asyncapi` | Channels + schemas + `x-protocol-source` (per-device connection + binding for the gateway to dial) + `x-enum-values` |
